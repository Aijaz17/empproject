...
<body>
    ...
    <h2 class="text-center p-4 bg-dark text-light">Search Employee TO Update</h2>
        ...
        <tbody>
            ...
            <tr class="">
               ...
               <td> <img src="./<?php echo $data['image'] ?>" alt="" width="40px" height="40px"></td>
                ...
                <td><a href="update2.php?id=<?php echo $data['id']; ?>" class="btn btn-success btn-sm " >Update</a></td>
